...
const Page = () => {
  ...
  return (
   ...
   <div className='w-[100%] lg:w-[65%] flex justify-center items-center flex-col h-full'>
        {!state.result && <div className={`${state.step > 1 && state.step <= 6 ? "block": "hidden"} w-[300px] lg:w-[400px] xl:w-[600px] flex items-center justify-between mt-3`}>
          ...
          <div className={`w-[calc((100%_-_136px)_/_2)] h-[10px]  rounded-full ${state.step >= 3 ? "bg-[#080a36]" : "bg-gray-300"}`}></div>
          ...
          <div className={`w-[calc((100%_-_136px)_/_2)] h-[10px]  rounded-full ${state.step >= 6 ? "bg-[#080a36]" : "bg-gray-300"}`}></div>
          <div className={`w-10 h-10 rounded-full flex justify-center items-center ${state.step >= 6 ? "bg-[#080a36]" : "bg-gray-300"}`}>
